    ...
    public class DbInitializer
    {
        public static void Initialize(LibraryDbContext bookDbContext)
        {
            ...
            bookDbContext.Books.AddRange(
                ...
                new Book() { Author = "jjj", Title = "titre10", Price = "23.40", Contenu = "con", Genres = new() { Romance } },
                new Book() { Author = "kkk", Title = "titre11", Price = "20.99", Contenu = "tenu", Genres = new() { Thriller } },
                new Book() { Author = "bbb", Title = "titre12", Price = "20.34", Contenu = "2", Genres = new() { Classic } }
            );
